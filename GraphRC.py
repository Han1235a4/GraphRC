...
def Loss_cal(Prediction=None,Real_data=None,Method=0):
    ...
    if Method==1:
        ...
        #plt.plot(Loss_int)
        # print(Loss_int)
        Loss_Final_mean=np.mean(Loss_int)
        Loss_Final_median=np.median(Loss_int)
    ...
    #MAPE
        ...
        Loss_Final_mean=np.mean(Loss_int)*100
        Loss_Final_median=np.median(Loss_int)*100
    return Loss_Final_mean,Loss_Final_median
